        ...
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
              ...
              >
                <span
                  v-if="deleteReservationMutation.isPending.value"
          ...
          <div class="modal-body">
            <form @submit.prevent="handleUpdateReservation">
              <div class="mb-3">
                ...
                <input
                  v-model.number="reservationForm.row"
                  type="number"
                  class="form-control"
                  required
                  min="1"
              ...
              <div class="mb-3">
                ...
                <input
                  v-model.number="reservationForm.col"
                  type="number"
                  class="form-control"
                  required
                  min="1"
              ...
              <div class="d-flex justify-content-end gap-2">
                ...
                >
                  <span
                    v-if="updateReservationMutation.isPending.value"
                    class="spinner-border spinner-border-sm me-1"
                  ></span>
                  Save Changes
                </button>
          ...
          <div class="modal-body">
            <form @submit.prevent="handleSavePurchase">
              ...
              <div class="mb-3">
                ...
                <input
                  v-model.number="purchaseFormPrice"
                  type="number"
                  step="0.01"
                  class="form-control"
                  required
              ...
              <div class="mb-3">
                ...
                <input
                  v-model.number="purchaseForm.count"
                  type="number"
                  class="form-control"
                  required
                  min="1"
              ...
              <div class="d-flex justify-content-end gap-2">
                ...
                <button
                  ...
                  class="btn btn-primary"
                  :disabled="
                    createPurchaseMutation.isPending.value || updatePurchaseMutation.isPending.value
                  "
                >
                  <span
                    v-if="

            ...
            <div v-for="room in rooms" :key="room.id" class="col-md-6 col-lg-4">
                <div class="card h-100">
                    ...
                    <div v-if="isAdmin" class="card-footer bg-transparent border-top-0 pt-0">
                        <div class="d-flex gap-2">
                            <button class="btn btn-sm btn-outline-primary flex-fill" @click.stop="showEditModal(room)">
                                Edit
                            </button>
                            <button class="btn btn-sm btn-outline-danger flex-fill" @click.stop="handleDelete(room.id!)"
                        ...
                        <form @submit.prevent="handleSave">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input v-model.number="roomForm.rows" type="number" class="form-control" required
                                        min="1" max="100" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Columns</label>
                                    <input v-model.number="roomForm.columns" type="number" class="form-control" required
                                        min="1" max="100" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input v-model.number="roomForm.opening_hour" type="number" class="form-control"
                                        required min="0" max="24" />
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Closing Hour (0-24)</label>
                                    <input v-model.number="roomForm.closing_hour" type="number" class="form-control"
                                        required min="0" max="24" />
                                </div>
                            </div>

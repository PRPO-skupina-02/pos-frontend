<template>
  <div class="container-fluid py-4 vh-100 d-flex flex-column">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <router-link
        :to="{ name: 'timeslots', params: { theaterId, roomId } }"
        ...
        <div class="card mb-3">
          <div class="card-body py-2">
            <div class="d-flex justify-content-center gap-4">
              ...
              <div class="d-flex align-items-center">
                <div
                  class="bg-danger border border-danger border-2 rounded me-2"
              ...
              <div class="d-flex align-items-center">
                <div
                  class="bg-success border border-success border-2 rounded me-2"
                  style="width: 30px; height: 30px"
                ></div>
        ...
        <div class="card h-100 d-flex flex-column">
          ...
          <div class="card-body overflow-auto flex-grow-1">
            <div v-if="selectedSeats.length > 0" class="mb-3">
              ...
              >
                <span
                  v-if="createReservationMutation.isPending.value"
